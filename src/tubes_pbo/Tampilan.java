...
import koneksi_login.datauser_konek;
...
public class Tampilan extends javax.swing.JFrame {
    ...
    public Tampilan() throws SQLException {
        try{
            initComponents();
            java.sql.Connection conn = datauser_konek.configDB();
            java.sql.Statement stm = conn.createStatement();
            
            ResultSet result = stm.executeQuery("SELECT * FROM datauser");
            ...
            while(result.next()) {
                ...
                text = String.format(text, 
                        ...
                        result.getString("alamat_lahir"),
                        result.getString("alamat_sekarang"),
